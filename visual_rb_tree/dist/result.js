...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rbtree = __webpack_require__(328);
	
	var _tree = __webpack_require__(331);
	
	__webpack_require__(333);
	
	var addForm = document.forms.insertform;
	...
	function handlerAdd(e) {
	  e.preventDefault();
	  var n = inputForAdd.value;
	  if (n.search(/^\d{1,6}$/) === -1) {
	    var message = document.querySelector(".message");
	    message.textContent = "Apenas números!  ";
	    setTimeout(function () {
	  ...
	  list = (0, _rbtree.add)(list, parseInt(n, 10));
	  inputForAdd.value = "";
	  ...
	  try {
	    for (var _iterator = document.querySelectorAll(".row")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var row = _step.value;
	  ...
	  tree = new _tree.Tree(list);
	  tree.draw();
	}
	
	function handlerDel(e) {
	  e.preventDefault();
	  var n = inputForDel.value;
	  if (n.search(/^\d{1,6}$/) === -1) {
	    var message = document.querySelector(".message");
	    message.textContent = "Apenas números";
	    setTimeout(function () {
	  ...
	  list = (0, _rbtree.remove)(list, parseInt(n, 10));
	  inputForDel.value = "";
	  ...
	  try {
	    for (var _iterator2 = document.querySelectorAll(".row")[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function add(tree, value) {
	  var newNode = {
	    ...
	    right: null,
	    parent: null,
	    color: _constants.RED
	  };
	
	  if (!tree) {
	    newNode.color = _constants.BLACK;
	    return newNode;
	  }
	
	  var resultTree = (0, _functions.cloneTree)(tree);
	
	  var parentNode = void 0;
	  var currentNode = resultTree;
	  ...
	  while (currentNode.color === _constants.RED && currentNode.parent && currentNode.parent.color === _constants.RED) {
	    var uncle = (0, _functions.getUncle)(currentNode);
	    var grandFather = (0, _functions.getGrandFather)(currentNode);
	    var _currentNode = currentNode,
	        parent = _currentNode.parent;
	
	
	    if (uncle && uncle.color === _constants.RED) {
	      parent.color = _constants.BLACK;
	      uncle.color = _constants.BLACK;
	      grandFather.color = _constants.RED;
	      currentNode = grandFather;
	      if (!currentNode.parent) currentNode.color = _constants.BLACK;
	      continue;
	    }
	
	    if (!uncle || uncle.color === _constants.BLACK) {
	      var sideOfTree = parent === grandFather.left ? _constants.LEFT : _constants.RIGHT;
	      var anotherDirection = parent === grandFather.right ? _constants.LEFT : _constants.RIGHT;
	
	      if (parent[sideOfTree] === currentNode) {
	        currentNode = parent;
	        (0, _functions.rotate)(currentNode, anotherDirection);
	        currentNode.color = _constants.BLACK;
	        currentNode[anotherDirection].color = _constants.RED;
	      } else {
	...
	function remove(tree, value) {
	  var resultTree = (0, _functions.cloneTree)(tree);
	  var deletedNode = resultTree;
	
	  while (value !== deletedNode.value) {
	    if (value > deletedNode.value) deletedNode = deletedNode.right;else deletedNode = deletedNode.left;
	    if (!deletedNode) return resultTree;
	  }
	
	  var maxInLeft = deletedNode;
	  if (deletedNode.left) {
	  ...
	  var direction = parent.left === currentNode ? _constants.LEFT : _constants.RIGHT;
	  var anotherDirection = parent.left === currentNode ? _constants.RIGHT : _constants.LEFT;
	  ...
	  while (currentNode.color === 0 && currentNode.parent) {
	    ...
	    if (sibling.color === _constants.RED) {
	      sibling.color = _constants.BLACK;
	      currentParent.color = _constants.RED;
	      (0, _functions.rotate)(sibling, direction);
	      continue;
	    }
	
	    if ((!nephewDirection || nephewDirection.color === _constants.BLACK) && (!nephewAnother || nephewAnother.color === _constants.BLACK)) {
	      sibling.color = _constants.RED;
	      currentParent.color = _constants.BLACK;
	      break;
	    }
	    ...
	    if (nephewAnother && nephewAnother.color === _constants.RED) {
	      sibling.color = currentParent.color;
	      currentParent.color = _constants.BLACK;
	      nephewAnother.color = _constants.BLACK;
	      (0, _functions.rotate)(sibling, direction);
	      break;
	    }
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.buildTree = exports.rotate = exports.getSibling = exports.getGrandFather = exports.getUncle = exports.cloneTree = undefined;
	...
	var cloneTree = function cloneTree(tree) {
	  ...
	  Object.keys(tree).forEach(function (key) {
	    if (tree[key] && _typeof(tree[key]) === 'object') {
	...
	var getGrandFather = function getGrandFather(node) {
	...
	var getUncle = function getUncle(node) {
	...
	var getSibling = function getSibling(node) {
	  var parent = node.parent;
	...
	var rotate = function rotate(node, direction) {
	  var another = direction === _constants.LEFT ? _constants.RIGHT : _constants.LEFT;
	  var parent = node.parent;
	  ...
	  if (grandFather) {
	    var sideGrandfather = grandFather.left === parent ? _constants.LEFT : _constants.RIGHT;
	...
	exports.getGrandFather = getGrandFather;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _node = __webpack_require__(332);
	...
	var Tree = function () {
	  ...
	  _createClass(Tree, [{
	    ...
	    value: function draw() {
	      ...
	      try {
	        for (var _iterator = document.querySelectorAll('canvas')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var cnv = _step.value;
	      ...
	      this.leaves.forEach(function (leaf, idx) {
	        var field = void 0;
	        ...
	        var _ref = leaf ? leaf : { value: 'none' },
	            value = _ref.value;
	
	        var color = !leaf || leaf.color === 1 ? 'red' : 'black';
	        _this.nodes[idx] = new _node.Node({ value: value, color: color, field: field });
	      });
	      this._drawLines();
	    }
	  }, {
